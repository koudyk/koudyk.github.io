...
- On the left sidebar below my bio, there are three sets of clickable buttons (like tags): (1) Categories, (2) Subjects, and (3) Skills. Clicking one of the buttons makes it so only the posts with those tags are listed. For example, under Skills, you can click on the button “Data visualization” to find posts that involved using that skill.
...
### Version 2: Rethinking the thesauri and visualizing the implementation
...
I am still thinking about how best to display and organize the categories and tags in the left sidebar of the website.
...
Finally, I think the figure showing the rendering of the data in the .ts and .md files is too long.
Ideally, it should fit on the screen while remaining legible so that readers can look at the data files and their rendering at the same time.
